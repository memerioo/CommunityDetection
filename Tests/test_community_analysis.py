...
class TestCommunityAnalysis(unittest.TestCase):
    ...
    def test_prepare_community_stats(self):
        """
        Tests the generation of initial community statistics based on a partition and labeled papers.
        ...
        result = prepare_community_stats(self.partition, self.labeled_papers)
    ...
    def test_perform_fisher_analysis(self):
        ...
        """
        community_stats = prepare_community_stats(self.partition, self.labeled_papers)
